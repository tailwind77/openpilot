...
class CAR:
  KIA_K7 = "KIA ALL NEW K7 LIMITED 2017-2019"
  KIA_K7_HEV = "KIA ALL NEW K7 HYBRID 2017-2019"
...
FEATURES = {
  ...
  "use_cluster_gears": [CAR.KIA_K7, CAR.ELANTRA, CAR.KONA, CAR.ELANTRA_GT_I30],
  # Use TCU Message for Gear Selection
  "use_tcu_gears": [CAR.KIA_OPTIMA],                                    
  # Use E_GEAR Message for Gear Selection
  "use_elect_gears": [CAR.KIA_K7_HEV, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.SONATA_H, CAR.KIA_NIRO_EV],
